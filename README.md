Steps for using Inbreeding detective/n
Step 1: download current bird list by checking [File] -> [Make a copy] -> [Download copy]/n
Step 2: Change the directory ([dir_bird_list]) in the code to the directory of your folder that you keep the bird list excel file./n
Step 3: Make sure the file name of the Excel is the same as the one in [bl = pd.read_excel('')]/n
Step 4: Change the variables in [Male] and [Female] to the pair you want to investigate/n
Step 5: run the code and enjoy the results/n
